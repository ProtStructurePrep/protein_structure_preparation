...
RECEPTOR_PDB_FILE = 'prepared_protein_1TVK.pdb'
LIGAND_PDB_FILE = 'ligand_1TVK.pdb'
LIG_RESNAME = 'LIG'
SMILES = 'C/C(=C\c1csc(C)n1)[C@@H]1C[C@@H]2O[C@@H]2CCC[C@H](C)[C@H](O)[C@@H](C)C(=O)C(C)(C)[C@@H](O)CC(=O)O1'
